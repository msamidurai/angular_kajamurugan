/**
 * bookshelf.js v1.0.0
 * we have change close and open name for close-book and open-book
 */
(function() {
	...
	var supportAnimations = 'WebkitAnimation' in document.body.style ||
		...
		// animation end event namepage-layout
	...
	Book.prototype._close = function() {
		...
		classie.remove( this.el, 'open-book' );
		classie.add( this.el, 'close-book' );
		...
		var self = this,
			onCloseBookEndFn = function( ev ) {
				...
				classie.remove( self.el, 'close-book' );
